      ...
      <SafeAreaView style={styles.container}>
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.contentContainer}>
          ...
          >
            ...
            >
              <Text style={styles.title}>Simple Point Table Maker</Text>
            </LinearGradient>
            <Text style={styles.subtitle}>Create Point Tables Easily</Text>
            <Text style={styles.dpiNote}>Recommended DPI : 600</Text>
          </Animated.View>
