  ...
  return (
    <GlassContainer style={styles.container} intensity={20}>
      ...
      <View style={styles.headerRow}>
        ...
        {meta.showTeamLogos && <Text style={[styles.headerCell, styles.logoCell]}>LOGO</Text>}
      ...
      <ScrollView style={styles.tableBody}>
        {sortedTeams.map((team, index) => (
          <TeamRow key={team.id} team={team} rank={index + 1} showLogo={meta.showTeamLogos} />
        ))}
      </ScrollView>
...
const TeamRow: React.FC<{ team: Team; rank: number; showLogo: boolean }> = ({ team, rank, showLogo }) => {
  return (
    <Animated.View 
    ...
    >
      ...
      <View style={[styles.cell, styles.dataCell]}>
        <Text style={styles.statText}>{team.wins || 0}</Text>
      </View>
      
      <View style={[styles.cell, styles.dataCell]}>
        <Text style={styles.statText}>{team.pp || 0}</Text>
      </View>
      
      <View style={[styles.cell, styles.dataCell]}>
        <Text style={styles.statText}>{team.kp || 0}</Text>
      </View>
