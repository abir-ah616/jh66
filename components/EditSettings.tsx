      ...
      <ScrollView style={styles.settingsContainer}>
        <View style={styles.section}>
          ...
          <View style={styles.settingRow}>
            ...
            <TextInput
              style={styles.input}
              value={meta.week ? meta.week.toString() : ''}
              onChangeText={(text) => {
                const week = text === '' ? 0 : parseInt(text.replace(/[^0-9]/g, ''));
                handleMetaChange('week', week);
              }}
          ...
          <View style={styles.settingRow}>
            ...
            <TextInput
              style={styles.input}
              value={meta.day ? meta.day.toString() : ''}
              onChangeText={(text) => {
                const day = text === '' ? 0 : parseInt(text.replace(/[^0-9]/g, ''));
                handleMetaChange('day', day);
              }}
              keyboardType="numeric"
              maxLength={2}
              placeholder="0"
          ...
          <View style={styles.settingRow}>
            <Text style={styles.settingLabel}>Show Team Logos</Text>
            <Switch
              value={meta.showTeamLogos}
              onValueChange={(value) => handleMetaChange('showTeamLogos', value)}
              trackColor={{ false: 'rgba(255, 255, 255, 0.1)', true: 'rgba(78, 84, 200, 0.7)' }}
              thumbColor={meta.showTeamLogos ? '#ffffff' : '#f4f3f4'}
            />
          </View>
          ...
          <View style={styles.settingRow}>
            ...
            <TextInput
              ...
              placeholder="Upload on catbox.moe"
              placeholderTextColor="rgba(255, 255, 255, 0.5)"
            />
          </View>
        </View>
